module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    concat: {
      dist: {
        src: [
          'app/scripts/controllers/informativeLabel.controller.js',
          'app/scripts/controllers/styleSelect.controller.js',
          'app/scripts/controllers/iconSelect.controller.js'
        ],
        dest: '<%= dest %>/<%= basePath %>/js/srh.information.js',
        nonull: true
      }
    },
    ...
    less: {
      dist: {
        ...
        files: {
          '<%= dest %>/<%= basePath %>/css/srh.information.css': 'app/styles/srh.information.less',
        }
      }
    },
